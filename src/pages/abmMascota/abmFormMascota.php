...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" required name="raza" class="form-control" placeholder="Raza" value="<?= $raza ?>">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" required name="color" class="form-control" placeholder="Color" value="<?= $color ?>">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="formFile" class="form-label">Fecha de muerte</label>
    <input type="date" name="fechaMuerte" class="form-control" placeholder="Fecha de muerte"
      value="<?= $fecha_muerte ?>">
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Usted esta a punto de modificar una mascota</h1>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="action" value="updateEntity">Si</button>
        </div>
      </div>
    </div>
  </div>
